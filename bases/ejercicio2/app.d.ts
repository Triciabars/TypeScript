...
declare const noHaceNada: (numero: number, texto: string, booleano: boolean, arreglo: any[]) => void;
declare let noHaceNadaTampoco: (n: number, s: string, b: boolean, a: any[]) => void;
